...
""" RUN THIS GIVEN CODE TO START TRAINING
 python references/detection/train.py db_resnet50
  --train_path /home/mohit/13October/doctr/references/training_data
   --val_path /home/mohit/13October/doctr/references/testing_data   --epochs 5 """
